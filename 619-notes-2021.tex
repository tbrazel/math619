...
\begin{figure}[h]
  \includegraphics[scale=.3]{pics/cubefig.png}
  \centering
...
\begin{figure}[h]
  \includegraphics[scale=.5]{pics/homotopy.png}
  \centering
...
\begin{definition} The \textit{homotopy fiber}\index[ind]{homotopy fiber} of $f$ (occasionally denoted $\hofib(f)$) is the fiber $Ff_y := p^{-1}(y)$, for the map $Nf\xtto{p} X$ above. That is,
\begin{align*}
