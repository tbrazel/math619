...
\[ \begin{tikzcd}
    A \times B\rar["f \times g"]\dar["f \times g" left] & C \times D\dar["\id \times \id" right]\\
    C \times D \rar["\id \times \id" below] & C \times D.
\end{tikzcd} \]
